        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-12" style="margin-top: 5%">
                    <div class="row">
                        <div class="col-lg-1">
                            <img src="<?php echo e(asset('/assets/images/check.png')); ?>"class="img-check">
                        </div>
                        <div class="col-lg-5">
                            <h3>
...
/></noscript>
    ...
    <script src="<?php echo e(asset('/assets/js/jquery.easing.min.js')); ?>"></script> <!-- jQuery Easing for smooth scrolling between anchors -->
    <script src="<?php echo e(asset('/assets/js/swiper.min.js')); ?>"></script> <!-- Swiper for image and text sliders -->
    <script src="<?php echo e(asset('/assets/js/jquery.magnific-popup.js')); ?>"></script> <!-- Magnific Popup for lightboxes -->
    <script src="<?php echo e(asset('/assets/js/morphext.min.js')); ?>"></script> <!-- Morphtext rotating text in the header -->
    <script src="<?php echo e(asset('/assets/js/validator.min.js')); ?>"></script> <!-- Validator.js - Bootstrap plugin that validates forms -->
    <script src="<?php echo e(asset('/assets/js/scripts.js')); ?>"></script> <!-- Custom scripts -->
</body>
</html><?php /**PATH /home/noob/project/digiflux/resources/views/landing.blade.php ENDPATH**/ ?>